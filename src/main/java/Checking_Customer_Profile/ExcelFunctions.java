...
public class ExcelFunctions {
    ...
    public void WriteToCell(String runStatus, String clientCode, String aulRegister,String linkedAccounts,String results, int iScenario,int ColumnRunStatus, int ColumnClientCode, int ColumnAulRegister, int ColumnLinkedAccounts, int ColumnResults) throws IOException {
