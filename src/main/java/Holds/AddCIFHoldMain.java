...
public class AddCIFHoldMain {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String filePath = System.getProperty("user.dir")+"\\Data_File\\Fica_Holds_Excel\\addCIFHold.xlsx";
                ...
                for(int y = 1; y < ExcelFunctions.ScenarioCount; y++)
                {
                    ...
                    if(runStatus.equalsIgnoreCase("RUN"))
                    {
                        ...
                        if(userLoggedIn){
                            ...
                            message = ficaHolds.addCIFHold(userData,clientID,"NO","NO","NO","NO","YES","NO","NO","NO","YES");
