...
public class RemoveFicLock {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String filePath = System.getProperty("user.dir")+"\\Data_File\\Fica_Holds_Excel\\RemoveFicHold.xlsx";
                ...
                for(int y = 1; y < ExcelFunctions.ScenarioCount; y++)
                {
                    ...
                    if(runStatus.equalsIgnoreCase("RUN"))
                    {
                        ...
                        if(userLoggedIn){
                            ...
                            message = ficaHolds.removeFicHold(userData,clientID);

                            if(message.equalsIgnoreCase("< Data entry too short") || message.equals("CLIENT IS NOT IN FIC LOCK") || message.equalsIgnoreCase("FICA FIELDS NOT COMPLETED ON C"))
                            {
