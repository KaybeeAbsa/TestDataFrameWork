...
public class ExcelFunctions {
    ...
    public void WriteToCell(String results, String runstatus , String ulRegistration,int iScenario,int ColumnCount, int ColumnRunStatus, int ColumnUlRegistration) throws IOException {
        ...
        cell1.setCellValue(runstatus);


        Cell cell2 = row.getCell(ColumnUlRegistration);
        if (cell2 == null) {
            cell2 = row.createCell(ColumnUlRegistration);
        }
        cell2.setCellValue(ulRegistration);
